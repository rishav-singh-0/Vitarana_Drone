...
class marker_detection():
    ...
    def __init__(self):
        ...
        self.logo_cascade = cv2.CascadeClassifier(os.path.join(
            os.path.dirname(os.path.realpath(__file__)), '../data/cascade.xml'))
        ...
        # Publish
        self.marker_error = rospy.Publisher(
            '/marker_error', NavSatFix, queue_size=1)
