...
class PathPlanner():
    ...
    def __init__(self):
        ...
        self.destination_xy = [0, 0]    # Converting latitude and longitude in meters for calculation

        # Present Location of the DroneNote
        self.current_location = [0, 0, 0]
        self.current_location_xy = [0, 0]   # Converting latitude and longitude in meters for calculation
        ...
        self.diff_xy = [0, 0]               # diffrence of current and final position
        ...
        self.movement_in_plane = [0, 0]     # [x, y] -> movement distribution in x and y
        self.obs_closest_range = 8          # closest distance of obstacle (in meters)
    ...
    def obstacle_avoid(self):
        ...
        if self.destination == [0, 0, 0]: return
