...
class PathPlanner():
    ...
    def destination_check(self):
        ...
        if -0.000050217 <= (self.destination_list[0][0]-self.current_location[0]) <= 0.000050217:
            if -0.0000087487 <= (self.destination_list[0][1]-self.current_location[1])<= 0.0000087487:
    ...
    def obstacle_avoid(self):
        ...
        for obs_distance in data:
            if obs_distance > 25:
                obs_distance = 24
            self.movement_in_1D = obs_distance * 0.60
            # if 16 <= obs_distance:
